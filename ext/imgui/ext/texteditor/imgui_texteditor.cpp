...
static bool TokenizeQASMStyleString(const char * in_begin, const char * in_end, const char *& out_begin, const char *& out_end)
{
    const char * p = in_begin;
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::QASM()
{
    static bool inited = false;
    static LanguageDefinition langDef;
    ...
    if (!inited)
    {
        langDef.mTokenize = [](const char * in_begin, const char * in_end, const char *& out_begin, const char *& out_end, PaletteIndex & paletteIndex) -> bool
        {
            ...
            if (in_begin == in_end)
            {
                ...
                paletteIndex = PaletteIndex::String;
            else if (TokenizeQASMStyleString(in_begin, in_end, out_begin, out_end))
                paletteIndex = PaletteIndex::String;
            else if (TokenizeCStyleCharacterLiteral(in_begin, in_end, out_begin, out_end))
                paletteIndex = PaletteIndex::CharLiteral;
            else if (TokenizeCStyleIdentifier(in_begin, in_end, out_begin, out_end))
